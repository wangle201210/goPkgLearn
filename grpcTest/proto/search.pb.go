...
var file_proto_search_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0x7e, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x65,
	...
	0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x34,
	0x0a, 0x03, 0x4d, 0x44, 0x35, 0x12, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x65,
...
var file_proto_search_proto_depIdxs = []int32{
	...
	0, // 1: proto.SearchService.MD5:input_type -> proto.SearchRequest
	1, // 2: proto.SearchService.Search:output_type -> proto.SearchResponse
	1, // 3: proto.SearchService.MD5:output_type -> proto.SearchResponse
...
type SearchServiceClient interface {
	...
	MD5(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error)
}
...
func (c *searchServiceClient) MD5(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	out := new(SearchResponse)
	err := c.cc.Invoke(ctx, "/proto.SearchService/MD5", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServiceServer interface {
	...
	MD5(context.Context, *SearchRequest) (*SearchResponse, error)
}
...
func (*UnimplementedSearchServiceServer) MD5(context.Context, *SearchRequest) (*SearchResponse, error) {
...
func _SearchService_MD5_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SearchServiceServer).MD5(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.SearchService/MD5",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).MD5(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SearchService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MD5",
			Handler:    _SearchService_MD5_Handler,
		},
	},
